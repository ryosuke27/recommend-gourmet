...
Route::get('/favorite/{dish_id}/add', [App\Http\Controllers\FavoriteController::class, 'add'])->name('favorite.add');
Route::get('/favorite/{dish_id}/delete', [App\Http\Controllers\FavoriteController::class, 'delete'])->name('favorite.remove');
